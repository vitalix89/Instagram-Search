...
or other details to help you with your experience.</div>
      ...
      <p>&nbsp;</p>
      <div className="innerText">If you turn cookies off, Some of the features that make your site experience more efficient may not function properly.that make your site experience more efficient and may not function properly.</div>
      <p><br /><span id="trDi" /></p>
      ...
      <div className="innerText"><br /><strong>According to CalOPPA, we agree to the following:</strong></div>
      <div className="innerText">Users can visit our site anonymously.</div>
      <div className="innerText">Once this privacy policy is created, we will add a link to it on our home page or as a minimum, on the first significant page after entering our website.</div>
      ...
      <div className="innerText">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>&bull;</strong> Via Email</div>
      <div className="innerText">Can change your personal information:</div>
      <div className="innerText">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>&bull;</strong> By emailing us</div>
      <div className="innerText"><br /><strong>How does our site handle Do Not Track signals?</strong></div>
      ...
      <div className="innerText"><br /><strong>Does our site allow third-party behavioral tracking?</strong></div>
      <div className="innerText">It's also important to note that we allow third-party behavioral tracking</div>
      <p>&nbsp;</p>
      ...
      <p>and we will promptly remove you from <strong>ALL</strong> correspondence.<br /><span id="ourCon" /></p>
      ...
      <div className="innerText">https://globalphotosearch.herokuapp.com/</div>
      <div className="innerText">Kashani 3c</div>
      <p>Tel-Aviv, Tel-Aviv 61000</p>
      <div className="innerText">Israel</div>
      <div className="innerText">vitaly89@walla.com</div>
      <div className="innerText"><br />Last Edited on 2017-02-27</div>
    </div>
  </div>
  );
